 ...
 * Version : 1.0.0
 */
public class StaggeredGridFragment extends BaseFragmentV4 {
    ...
    public void doBusiness() {
        Log.i("print", "doBusiness  " + this.getClass().getSimpleName()); queryData(ContactManager.onRefresh);
    }

    @Override
    public void initView(View view) {
        Log.i("print", "initView  " + this.getClass().getSimpleName()); setRecyclerView();
    }
